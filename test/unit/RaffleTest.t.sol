...
contract RaffleTest is Test {
    ...
    function testEmitsEventsOnEntrance() public {
        ...
        emit EnteredRaffle(PLAYER); // what we expect from the next line
        raffle.enterRaffle{value: entranceFee}();
    }
    ...
    // What if we need to test using the outputs of our events?
    ...
    function testFulfillRandomWordsCanOnlyBeCalledAfterPerformUpkeep(
        uint256 randomRequestId // foundry will create this for us and run tests multiple times
        ...
        skipFork
    {
        ...
        for (
            ...
            address player = address(uint160(i)); // address based off index
